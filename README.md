...
## Acknowledgements
We thank the Amsterdam-based creative studio [affect lab](https://www.affectlab.org/) and Dr. Natalie Dixon for providing access to the data of their [Ctrl.Alt.Img](https://www.affectlab.org/ctrlaltimg) project.
